...
from kinematics.core.display import (
    DisplayLink,
    RockerDisplayGroup,
    WheelAnchorNames,
...
from kinematics.core.primitives.types import PointTarget, SweepConfig
from kinematics.core.solver import SolverInfo
from kinematics.core.state import SuspensionState
from kinematics.core.suspensions.base import Suspension
from kinematics.core.sweep import SweepMetricsResult, compute_sweep_metrics, solve_sweep
...
def analyze_solved_sweep(
    ...
    point_keys = display_point_keys(topology)
    rocker_groups = rocker_display_groups(topology)
    ...
    return SweepAnalysis(
        ...
        links=display_links(topology),
        wheel_anchors=wheel_anchor_names(topology),
